    ...
    <!--<div class="row">
      ...
      <div class="col">
        <div class="mb-3">
          ...
          <select name="inputEstadoEmpresa" class="form-select">
            <option value="" selected>Selecione</option>
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <select name="inputGrauParentesco" class="form-select" form="updateParents<?php echo $parente->id; ?>">
                  <option selected>Selecione</option>
            ...
            <div class="col">
              <div class="mb-3">
                <label class="form-label mb-2" for="inputEstadoCivil">Estado Civil</label>
                <select name="inputEstadoCivil" class="form-select" form="updateParents<?php echo $parente->id; ?>">
                  <option selected>Selecione</option>
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <select name="inputEscolaridade" class="form-select" form="updateParents<?php echo $parente->id; ?>">
                  <option selected>Selecione</option>
    ...
    <div class="row">
      <div class="col">
        <div class="mb-3">
          ...
          <div class="form-check form-check-inline">
            <input <?php if($dados->Vestibular == 'Não'){ echo 'checked=checked';} ?> class="form-check-input" type="radio" name="inputVestibular" id="inputVestibular2" value="Não" onclick="hideInput('.dados-faculdade')">
