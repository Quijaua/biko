...
<div class="container">
  ...
  <div class="row mt-4 mb-4">
    <div class="col-auto">
      <a class="btn btn-block btn-danger" href="/coordenadores/edit/{{ $dados->id }}"><i class="me-2 fas fa-user-edit"></i> Editar Dados</a>
    </div>
    <div class="col-auto">
      <a class="btn btn-block btn-primary" href="/coordenadores"><i class="me-2 fas fa-arrow-left"></i> Voltar</a>
    </div>
    <div class="col-auto">
