...
<div class="container">
  ...
  <div class="row mt-4 mb-4">
    <div class="col-2">
      <a class="btn btn-block btn-danger" href="/coordenadores/edit/{{ $dados->id }}"><i class="fas fa-user-edit"></i> Editar Dados</a>
    </div>
    <div class="col-2">
      <a class="btn btn-block btn-primary" href="/coordenadores"><i class="fas fa-arrow-left"></i> Voltar</a>
    </div>
    <div class="col-2">
  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputNomeCoordenador" name="inputNomeCoordenador" aria-describedby="inputNomeCoordenadorHelp" value="{{ $dados->NomeCoordenador }}" disabled>
      </div>
    </div>
    <div class="col">
      <div class="form-group">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputFuncaoCoordenador" name="inputFuncaoCoordenador" aria-describedby="inputFuncaoCoordenadorHelp" value="{{ $dados->FuncaoCoordenador }}" disabled>
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <label for="inputAnoIngresso">Ano de Ingresso</label>
        <select name="inputAnoIngresso" class="custom-select" disabled>
          <option selected>Selecione</option>
          <option <?php if($dados->AnoIngresso == '2009'){ echo 'selected=selected';} ?> value="2009">2009</option>
          <option <?php if($dados->AnoIngresso == '2010'){ echo 'selected=selected';} ?> value="2010">2010</option>
          <option <?php if($dados->AnoIngresso == '2011'){ echo 'selected=selected';} ?> value="2011">2011</option>
          <option <?php if($dados->AnoIngresso == '2012'){ echo 'selected=selected';} ?> value="2012">2012</option>
          <option <?php if($dados->AnoIngresso == '2013'){ echo 'selected=selected';} ?> value="2013">2013</option>
          <option <?php if($dados->AnoIngresso == '2014'){ echo 'selected=selected';} ?> value="2014">2014</option>
          <option <?php if($dados->AnoIngresso == '2015'){ echo 'selected=selected';} ?> value="2015">2015</option>
          <option <?php if($dados->AnoIngresso == '2016'){ echo 'selected=selected';} ?> value="2016">2016</option>
          <option <?php if($dados->AnoIngresso == '2017'){ echo 'selected=selected';} ?> value="2017">2017</option>
          <option <?php if($dados->AnoIngresso == '2018'){ echo 'selected=selected';} ?> value="2018">2018</option>
          <option <?php if($dados->AnoIngresso == '2019'){ echo 'selected=selected';} ?> value="2019">2019</option>
          <option <?php if($dados->AnoIngresso == '2020'){ echo 'selected=selected';} ?> value="2020">2020</option>
          <option <?php if($dados->AnoIngresso == '2021'){ echo 'selected=selected';} ?> value="2021">2021</option>
        </select>
      </div>
    </div>
    <div class="col">
      <div class="form-check">
        <input <?php if($dados->RepresentanteCGU === 'sim'){ echo 'checked=checked'; } ?> class="form-check-input" type="checkbox" name="inputRepresentanteCGU" id="inputRepresentanteCGU" value="{{ $dados->RepresentanteCGU }}" disabled>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputFormacaoSuperior" name="inputFormacaoSuperior" aria-describedby="inputFormacaoSuperiorHelp" placeholder="Sua formação no ensino superior" value="{{ $dados->FormacaoSuperior }}" disabled>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <br><br>
        <input type="text" class="form-control" id="inputAnoInicioUneafro" name="inputAnoInicioUneafro" aria-describedby="inputAnoInicioUneafroHelp" placeholder="Ano em que iniciou na UNEAFRO" value="{{ $dados->AnoInicioUneafro }}" disabled>
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        ...
        <br><br>
        <select name="aulasForaUneafro" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputEnsinoSuperior" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputAnoCursoSuperior1" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputAnoCursoSuperior2" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputEspecializacao" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputAnoCursoEspecializacao" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputMestrado" class="custom-select" disabled>
          <option selected>Selecione</option>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <select name="inputAnoCursoMestrado" class="custom-select" disabled>
          <option selected>Selecione</option>
