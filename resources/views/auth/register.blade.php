...
<div class="container">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            ...
                            <div class="mb-3">
                              ...
                              <label class="form-label mb-2" for="name">{{ __('Nome') }}</label>
                          ...
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="NomeSocial">{{ __('Nome Social') }}</label>
                        ...
                        <div class="row">
                          <div class="col-12 col-md-4">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="phone">{{ __('Celular') }}</label><br><br>
                          ...
                          <div class="col-12 col-md-4">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="email">{{ __('E-Mail') }}</label><br><br>
                          ...
                          <div class="col-12 col-md-4">
                            <div class="mb-3">
                              <label class="form-label mb-5" for="inputNucleo">Tem preferência por fazer as aulas em algum núcleo?</label>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <select name="responsavelCuidadoOutraPessoa" class="form-select">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="inputEndereco">Logradouro</label>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="inputCEPProprio">Esse CEP é seu ou uma referência?</label>
                              <select id="inputCEPProprio" name="inputCEPProprio" class="form-select" required>
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              ...
                              <select id="inputEstado" name="inputEstado" class="form-select" required>
                                <option value="" selected>Selecione</option>
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="inputEnsFundamental">Você cursou o Ensino Fundamental em:</label><br>
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="inputEnsMedio">Você cursou o Ensino Médio em:</label><br>
                              <div class="form-check form-check-inline">
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label mb-2" for="inputVestibular">Já prestou vestibular?</label>
                              <br>
    ...
    <div class="col-12 col-md-4">
        <div class="mb-3">
            <label class="form-label mb-2" for="inputVestibularOutraCidade">
                Quanto à Universidade, tem disponibilidade/interesse de estudar em outras cidades?
            </label>
            <select name="inputVestibularOutraCidade" id="inputVestibularOutraCidade" class="form-select">
                <option value="" selected>Selecione</option>
    ...
    <div class="col-12 col-md-4">
        <div class="mb-3">
            <label class="form-label mb-5" for="inputComoSoube">
                Como você ficou sabendo do cursinho pré-vestibular da UNEafro Brasil?
            </label>
            <select id="inputComoSoube" name="inputComoSoube" class="form-select" onchange="checkComosoube()">
                <option value="" selected>Selecione</option>
    ...
    <div class="col-12 col-md-4">
        <div class="mb-3">
            <label class="form-label mb-7" for="inputComoSoubeOutros">Outros (Qual?)</label>
    ...
    <input type="hidden" name="inputStatus" value="1">
                        ...
                        <!--<div class="mb-3 row">
                            <label class="form-label mb-2" for="password" class="col-md-4 col-form-label text-md-right">{{ __('Senha') }}</label>
                        ...
                        <!--<div class="mb-3 row">
                            <label class="form-label mb-2" for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirmar Senha') }}</label>
